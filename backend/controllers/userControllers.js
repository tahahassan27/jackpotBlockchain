...
const registerUser= async (req,res)=>{
    ...
    if(usersData){
        return res.status(200).send('This User Already Exists');
    }
    else{
...
= async (req,res, next)=>{
    ...
    let tx;
        try {
          ...
          tx = await contractWithWallet.enter(amount);
...
module.exports={
    registerUser, participateInJackpot, approve
}